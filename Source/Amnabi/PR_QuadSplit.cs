...
namespace Amnabi
{
    public class PR_QuadSplit : PR_Split
    {
                ...
                }, delegate
                {
                    layerNow.childLayer(this,
                            new Rect(layerNow.innerrect.x, layerNow.innerrect.y + (layerNow.innerrect.height / 2f),
                                layerNow.innerrect.width / 2f, layerNow.innerrect.height / 2f), depth)
                        .tagInc("SplitSub", 1).setBackground(fft.getRandomColor("Background", MI(2, depth)))
                        .iterateLayer(fft, depth);
                }, delegate
                {
                    layerNow.childLayer(this,
                        ...
                        .setBackground(fft.getRandomColor("Background", MI(3, depth)))
                        .iterateLayer(fft, depth);
                });
        }
    }
